    ...
    <div class="customizer_wrapper">
        ...
        <div class="customizer_element">
            <select name="demos_switcher" id="demos_switcher">
                ...
                <option value="http://smartyschool.stylemixthemes.com/school-two/"><?php esc_html_e( 'School Two', 'smarty' ); ?></option>
                <option value="http://smartyschool.stylemixthemes.com/university-two/"><?php esc_html_e( 'University Two', 'smarty' ); ?></option>
                <option value="http://smartyschool.stylemixthemes.com/kindergarten-two/"><?php esc_html_e( 'Kindergarten Two', 'smarty' ); ?></option>
            </select>
        </div>
        ...
        $("#demos_switcher").on("change", function() {
            ...
            switch( demosStyle ) {
                ...
                case "http://smartyschool.stylemixthemes.com/kindergarten/" :
                    ...
                    break;
                case "http://smartyschool.stylemixthemes.com/school-two/" :
                    window.location = "http://smartyschool.stylemixthemes.com/school-two/";
                    break;
                case "http://smartyschool.stylemixthemes.com/university-two/" :
                    window.location = "http://smartyschool.stylemixthemes.com/university-two/";
                    break;
                case "http://smartyschool.stylemixthemes.com/kindergarten-two/" :
                    window.location = "http://smartyschool.stylemixthemes.com/kindergarten-two/";
                    break;
            }
        });
